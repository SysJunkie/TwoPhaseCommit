...
\@x{ {\CONSTANT} RM ,\,\@s{42.53}}%
\@y{\@s{0}%
 The set of participating resource managers, \ensuremath{RM \.{=}
 1\.{\dotdot}3
}}%
\@xx{}%
\@x{\@s{50.17} RMMAYFAIL ,\,}%
...
\@x{\@s{50.17} ENABLEBTM}%
\@y{\@s{0}%
 Flag to enable the backup \ensuremath{TM} configuration
}%
\@xx{}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
...
\begin{cpar}{1}{F}{F}{0}{0}{}%
 A modified version of \ensuremath{P2TCommit} at
 http:\ensuremath{\.{\slsl}lamport.azurewebsites.net}/tla/two-\ensuremath{phase.html
} Transaction manager (\ensuremath{TM}) is added.
\end{cpar}%
\end{lcom}%
\pcalsymbolstrue
\pcalshadingtrue
...
\@xx{}%
\@x{\@s{51.42} tmState \.{=}\@w{init} {\p@semicolon}}%
\@x{\@s{51.42}}%
\@y{\@s{0}%
 Initial state of the backup \ensuremath{TM} set to inactive
}%
\@xx{}%
\@x{\@s{51.42} btmState \.{=}\@w{inactive} {\p@semicolon}}%
\@pvspace{8.0pt}%
\@x{\@s{8.2} {\p@define} {\p@lbrace}}%
\@x{\@s{16.4}}%
\@y{\@s{0}%
 can commit when only all \ensuremath{RM} are either in prepared state or
 have committed and the \ensuremath{TM} state is not in abort state
}%
\@xx{}%
 \@x{\@s{16.4} canCommit \.{\defeq} \A\, rm \.{\in} RM \.{:} rmState [ rm ]
 \.{\in} \{\@w{prepared} ,\,\@w{committed} ,\,\@w{failed} \} \.{\land}
 btmState \.{\neq}\@w{abort} \.{\land} tmState \.{\neq}\@w{abort}}%
\@x{\@s{16.4}}%
\@y{\@s{0}%
 can abort when only all \ensuremath{RM} are not in committed state and the
 \ensuremath{TM} state is not committed
}%
\@xx{}%
 \@x{\@s{16.4} canAbort \.{\defeq} ( \A\, rm \.{\in} RM \.{:} rmState [ rm ]
 \.{\neq}\@w{committed} \.{\land} ( tmState \.{\neq}\@w{commit} \.{\land}
 btmState \.{\neq}\@w{commit} ) )}%
\@x{\@s{12.29} {\p@rbrace}}%
\@pvspace{8.0pt}%
...
\@xx{}%
 \@x{\@s{24.59} {\p@if} {\p@lparen} rmState [ p ] \.{\neq}\@w{prepared}
 {\p@rparen} {\p@lbrace}}%
\@x{\@s{43.44} {\p@await} rmState [ p ] \.{=}\@w{working} {\p@semicolon}}%
\@x{\@s{43.44} rmState [ p ] \.{:=}\@w{prepared} {\p@semicolon}}%
\@x{\@s{24.59} {\p@rbrace}}%
\@x{\@s{12.29} {\p@rbrace}}%
\@pvspace{16.0pt}%
...
\@x{\@s{16.4}}%
\@y{\@s{0}%
 If \ensuremath{RMMAYFAIL} is True then the state of the \ensuremath{RM} may
 become failed
}%
\@xx{}%
\@x{\@s{16.4} {\p@if} {\p@lparen} RMMAYFAIL {\p@rparen} {\p@lbrace}}%
\@x{\@s{39.34} {\p@either} {\p@lbrace}}%
\@x{\@s{76.61} rmState [ p ] \.{:=}\@w{failed}}%
\@x{\@s{72.51} {\p@rbrace}}%
\@x{\@s{39.34} {\p@or} {\p@skip} {\p@semicolon}}%
...
\@x{\@s{12.29}}%
\@y{\@s{0}%
 each \ensuremath{RM} can access its own state and the \ensuremath{TM} state
 or Backup \ensuremath{TM} state
}%
\@xx{}%
\@x{\@s{12.29}}%
\@y{\@s{0}%
 Each \ensuremath{RM} will consult the Backup \ensuremath{TM} only when the
 \ensuremath{tmState} is hidden and Backup \ensuremath{TM} is enabled
}%
\@xx{}%
 \@x{\@s{16.4} {\p@either} {\p@lbrace} {\p@when} \.{\land} rmState [ p ]
 \.{=}\@w{prepared}}%
 \@x{\@s{89.33} \.{\land} ( tmState \.{=}\@w{commit} \.{\lor} ( tmState
 \.{=}\@w{hidden} \.{\land} ENABLEBTM \.{\land} btmState \.{=}\@w{commit} ) )
 {\p@semicolon}}%
\@x{\@s{59.14} rmState [ p ] \.{:=}\@w{committed}}%
\@x{\@s{49.56} {\p@rbrace}}%
\@x{\@s{49.56}}%
\@y{\@s{0}%
 \ensuremath{RM} can abort if its in working or prepared state provided
 \ensuremath{TM} sends abort
}%
\@xx{}%
 \@x{\@s{16.4} {\p@or}\@s{18.84} {\p@lbrace} {\p@when} \.{\land} rmState [ p ]
 \.{\in} \{\@w{working} ,\,\@w{prepared} \}}%
 \@x{\@s{89.33} \.{\land} ( tmState \.{=}\@w{abort} \.{\lor} ( tmState
 \.{=}\@w{hidden} \.{\land} ENABLEBTM \.{\land} btmState \.{=}\@w{abort} ) )
 {\p@semicolon}}%
\@x{\@s{59.14} rmState [ p ] \.{:=}\@w{aborted}}%
\@x{\@s{49.56} {\p@rbrace}}%
\@x{\@s{49.56}}%
\@y{\@s{0}%
 \ensuremath{RM} can spontaneously decide to abort if its in working state
}%
\@xx{}%
 \@x{\@s{16.4} {\p@or}\@s{12.29} {\p@lbrace} {\p@when} \.{\land} rmState [ p ]
 \.{\in} \{\@w{working} \} {\p@semicolon}}%
\@x{\@s{56.70} rmState [ p ] \.{:=}\@w{aborted}}%
\@x{\@s{43.01} {\p@rbrace}}%
\@x{\@s{12.29} {\p@rbrace}}%
\@pvspace{8.0pt}%
...
\@x{\@s{16.4}}%
\@y{\@s{0}%
 an \ensuremath{RM} can do any of the following when in working and prepared
 state
}%
\@xx{}%
 \@x{\@s{16.4} RS\@s{.5}\textrm{:}\@s{3} {\p@while} {\p@lparen} rmState [ self
 ] \.{\in} \{\@w{working} ,\,\@w{prepared} \} {\p@rparen} {\p@lbrace}}%
...
\@x{\@s{12.29}}%
\@y{\@s{0}%
 \ensuremath{TMANAGER} is operational process only as long as the
 \ensuremath{tmState} is not hidden
}%
\@xx{}%
 \@x{\@s{12.29} TS\@s{.5}\textrm{:}\@s{3}\@s{4.1} {\p@if} {\p@lparen} tmState
 \.{\neq}\@w{hidden} {\p@rparen} {\p@lbrace}}%
\@x{\@s{59.59} {\p@either} {\p@lbrace} {\p@await} canCommit {\p@semicolon}}%
 \@x{\@s{106.44} TC\@s{.5}\textrm{:}\@s{3} tmState \.{:=}\@w{commit}
 {\p@semicolon}}%
 \@x{\@s{106.44} F1\@s{.5}\textrm{:}\@s{3}\@s{2.90} {\p@if} {\p@lparen}
 TMMAYFAIL {\p@rparen} {\p@lbrace}}%
\@x{\@s{143.13}}%
\@y{\@s{0}%
 record the active \ensuremath{tmState} in backup \ensuremath{TM
}}%
\@xx{}%
\@x{\@s{143.13} btmState \.{:=} tmState {\p@semicolon}}%
\@x{\@s{143.13} tmState \.{:=}\@w{hidden}\@s{1.32} {\p@semicolon}}%
\@pvspace{8.0pt}%
\@x{\@s{132.59} {\p@rbrace}}%
\@y{\@s{0}%
 if
...
\@xx{}%
\@x{\@s{84.19} {\p@or}\@s{3.83} {\p@lbrace}}%
\@x{\@s{110.54} {\p@await} canAbort {\p@semicolon}}%
 \@x{\@s{110.54} TA\@s{.5}\textrm{:}\@s{3} tmState \.{:=}\@w{abort}
 {\p@semicolon}}%
 \@x{\@s{110.54} F2\@s{.5}\textrm{:}\@s{3}\@s{0.96} {\p@if} {\p@lparen}
 TMMAYFAIL {\p@rparen} {\p@lbrace}}%
\@x{\@s{145.29}}%
\@y{\@s{0}%
 record the active \ensuremath{tmState} in backup \ensuremath{TM
...
\@xx{}%
\@x{\@s{145.29} btmState \.{:=} tmState {\p@semicolon}}%
\@x{\@s{145.29} tmState \.{:=}\@w{hidden}\@s{1.32} {\p@semicolon}}%
\@x{\@s{118.74} {\p@rbrace}}%
\@y{\@s{0}%
 if
}%
...
\@x{\@s{16.4}}%
\@y{\@s{0}%
 Backup \ensuremath{TM} becomes active only when \ensuremath{TM} state is
 hidden and \ensuremath{ENABLEBTM} flag is set
}%
\@xx{}%
\@x{\@s{16.4}}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{\@s{16.4} BTS\@s{.5}\textrm{:}\@s{3} {\p@if} {\p@lparen} ENABLEBTM
 \.{\land} tmState \.{=}\@w{hidden} {\p@rparen} {\p@lbrace}}%
\@x{\@s{54.23} {\p@either} {\p@lbrace}}%
\@x{\@s{99.69} {\p@await} canCommit {\p@semicolon}}%
 \@x{\@s{99.69} BTC\@s{.5}\textrm{:}\@s{3} btmState \.{:=}\@w{commit}
 {\p@semicolon}}%
\@x{\@s{78.83} {\p@rbrace}}%
\@y{\@s{0}%
 either
...
\@xx{}%
\@x{\@s{78.83} {\p@or} {\p@lbrace}}%
\@x{\@s{105.45} {\p@await} canAbort {\p@semicolon}}%
 \@x{\@s{105.45} BTA\@s{.5}\textrm{:}\@s{3} btmState \.{:=}\@w{abort}
 {\p@semicolon}}%
\@x{\@s{97.25} {\p@rbrace}}%
\@y{\@s{0}%
 or
...
\vshade{5.0}%
\begin{cpar}{1}{F}{F}{0}{0}{}%
Below is the algorithm\mbox{'}s translation. The translation defines
...
\@xx{}%
 ...
 \{\@w{prepared} ,\,\@w{committed} ,\,\@w{failed} \} \.{\land} btmState
 \.{\neq}\@w{abort} \.{\land} tmState \.{\neq}\@w{abort}}%
\@pvspace{8.0pt}%
 \@x{ canAbort \.{\defeq} ( \A\, rm\@s{7.20} \.{\in} RM \.{:} rmState [ rm ]
 \.{\neq}\@w{committed} \.{\land} ( tmState \.{\neq}\@w{commit} \.{\land}
 btmState \.{\neq}\@w{commit} ) )}%
\@pvspace{16.0pt}%
...
\@x{\@s{35.70} \.{\land} btmState \.{=}\@w{inactive}}%
...
\@x{ RS ( self ) \.{\defeq} \.{\land} pc [ self ] \.{=}\@w{RS}}%
 ...
 ,\,\@w{prepared} \}}%
 \@x{\@s{80.47} \.{\THEN} \.{\land} \.{\lor} \.{\land} {\IF} rmState [ self ]
 \.{\neq}\@w{prepared}}%
\@x{\@s{157.27} \.{\THEN} \.{\land} rmState [ self ] \.{=}\@w{working}}%
 \@x{\@s{188.58} \.{\land} rmState \.{'} \.{=} [ rmState {\EXCEPT} {\bang} [
 self ] \.{=}\@w{prepared} ]}%
\@x{\@s{157.27} \.{\ELSE} \.{\land} {\TRUE}}%
\@x{\@s{188.58} \.{\land} {\UNCHANGED} rmState}%
 \@x{\@s{122.89} \.{\lor} \.{\land} \.{\lor} \.{\land} \.{\land} rmState [
 self ] \.{=}\@w{prepared}}%
 \@x{\@s{167.34} \.{\land} ( tmState \.{=}\@w{commit} \.{\lor} ( tmState
 \.{=}\@w{hidden} \.{\land} ENABLEBTM \.{\land} btmState \.{=}\@w{commit} )
 )}%
 \@x{\@s{156.23} \.{\land} rmState \.{'} \.{=} [ rmState {\EXCEPT} {\bang} [
 self ] \.{=}\@w{committed} ]}%
 \@x{\@s{145.12} \.{\lor} \.{\land} \.{\land} rmState [ self ] \.{\in}
 \{\@w{working} ,\,\@w{prepared} \}}%
 \@x{\@s{167.34} \.{\land} ( tmState \.{=}\@w{abort} \.{\lor} ( tmState
 \.{=}\@w{hidden} \.{\land} ENABLEBTM \.{\land} btmState \.{=}\@w{abort} ) )}%
 \@x{\@s{156.23} \.{\land} rmState \.{'} \.{=} [ rmState {\EXCEPT} {\bang} [
 self ] \.{=}\@w{aborted} ]}%
 \@x{\@s{145.12} \.{\lor} \.{\land} \.{\land} rmState [ self ] \.{\in}
...
\@x{\@s{122.89} \.{\lor} \.{\land} {\IF} RMMAYFAIL}%
 \@x{\@s{157.27} \.{\THEN} \.{\land} \.{\lor} \.{\land} rmState \.{'} \.{=} [
 rmState {\EXCEPT} {\bang} [ self ] \.{=}\@w{failed} ]}%
\@x{\@s{199.69} \.{\lor} \.{\land} {\TRUE}}%
\@x{\@s{210.80} \.{\land} {\UNCHANGED} rmState}%
\@x{\@s{157.27} \.{\ELSE} \.{\land} {\TRUE}}%
\@x{\@s{188.58} \.{\land} {\UNCHANGED} rmState}%
...
\@x{\@s{57.91} \.{\THEN} \.{\land} \.{\lor} \.{\land} canCommit}%
 \@x{\@s{111.45} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ 0 ]
 \.{=}\@w{TC} ]}%
\@x{\@s{100.34} \.{\lor} \.{\land} canAbort}%
 \@x{\@s{111.45} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ 0 ]
 \.{=}\@w{TA} ]}%
 \@x{\@s{57.91} \.{\ELSE} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ 0
 ] \.{=}\@w{Done} ]}%
...
\@x{\@s{57.91} \.{\THEN} \.{\land} btmState \.{'} \.{=} tmState}%
\@x{\@s{89.22} \.{\land} tmState \.{'} \.{=}\@w{hidden}}%
...
\@x{\@s{41.69} \.{\land} {\IF} ENABLEBTM \.{\land} tmState \.{=}\@w{hidden}}%
\@x{\@s{64.95} \.{\THEN} \.{\land} \.{\lor} \.{\land} canCommit}%
 \@x{\@s{118.49} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ 10 ]
 \.{=}\@w{BTC} ]}%
\@x{\@s{107.37} \.{\lor} \.{\land} canAbort}%
 \@x{\@s{118.49} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ 10 ]
 \.{=}\@w{BTA} ]}%
 \@x{\@s{64.95} \.{\ELSE} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ 10
 ] \.{=}\@w{Done} ]}%
 \@x{\@s{41.69} \.{\land} {\UNCHANGED} {\langle} rmState ,\, tmState ,\,
 btmState {\rangle}}%
\@pvspace{8.0pt}%
\@x{ BTC \.{\defeq} \.{\land} pc [ 10 ] \.{=}\@w{BTC}}%
\@x{\@s{41.69} \.{\land} btmState \.{'} \.{=}\@w{commit}}%
...
\@x{\@s{41.69} \.{\land} btmState \.{'} \.{=}\@w{abort}}%
 \@x{\@s{41.69} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ 10 ]
 \.{=}\@w{Done} ]}%
 \@x{\@s{41.69} \.{\land} {\UNCHANGED} {\langle} rmState ,\, tmState
 {\rangle}}%
...
\@x{}%
\@y{\@s{0}%
 For termination, all \ensuremath{RM} which have not failed should be in
 either \mbox{'}aborted\mbox{'} or
}%
\@xx{}%
\@x{}%
\@y{\@s{0}%
 \mbox{'}committed\mbox{'} state, \ensuremath{TM} or \ensuremath{BTM} state
 should be matching the \ensuremath{RM} states
}%
\@xx{}%
\@x{}%
\@y{\@s{0}%
 all process\mbox{'}s program counter should be at \mbox{'}Done\mbox{'}
}%
\@xx{}%
\@x{ Termination \.{\defeq} {\Diamond} ( (}%
 \@x{\@s{85.76} ( \A\, rm \.{\in} RM \.{:} rmState [ rm ] \.{\neq}\@w{failed}
 \.{\implies} rmState [ rm ] \.{=}\@w{committed} \.{\land} ( tmState
 \.{=}\@w{commit} \.{\lor} ( tmState \.{=}\@w{hidden} \.{\land} btmState
 \.{=}\@w{commit} ) ) )}%
 \@x{\@s{73.96} \.{\lor}\@s{0.69} ( \A\, rm \.{\in} RM \.{:} rmState [ rm ]
 \.{\neq}\@w{failed} \.{\implies} rmState [ rm ] \.{=}\@w{aborted} \.{\land}
 ( tmState \.{=}\@w{abort} \.{\lor} ( tmState \.{=}\@w{hidden} \.{\land}
 btmState \.{=}\@w{abort} ) ) ) )}%
 \@x{\@s{73.96} \.{\land}\@s{0.69} ( \A\, self \.{\in} ProcSet \.{:} pc [ self
 ] \.{=}\@w{Done} ) )}%
\@x{}%
\@y{\@s{0}%
 END TRANSLATION
...
\end{lcom}%
 ...
 ,\,\@w{prepared} ,\,\@w{committed} ,\,\@w{aborted} ,\,\@w{failed} \} ]}%
 \@x{\@s{8.2} \.{\land} tmState\@s{0.89} \.{\in} \{\@w{init} ,\,\@w{hidden}
 ,\,\@w{commit} ,\,\@w{abort} \}}%
 \@x{\@s{8.2} \.{\land} btmState \.{\in} \{\@w{inactive} ,\,\@w{commit}
 ,\,\@w{abort} \}}%
\@pvspace{16.0pt}%
\@x{ Consistent \.{\defeq}}%
\begin{lcom}{8.2}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Dec} 05 19:16:48 \ensuremath{EST} 2017 by \ensuremath{varunjai
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified \ensuremath{Tue}
 \ensuremath{Oct} 11 08:14:15 \ensuremath{PDT} 2011 by \ensuremath{lamport
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Mon} \ensuremath{Oct} 10
 05:31:02 \ensuremath{PDT} 2011 by \ensuremath{lamport
} Members:
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\cdash{8}
...
} \ensuremath{UBIT} Name: \ensuremath{varunjai
} Person\# - 50247176
\end{cpar}%
\vshade{10.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\vshade{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{TypeOK} Property:
 The states for all resource manager, transaction manager and backup
 transaction manager
 are defined.
\end{cpar}%
\vshade{5.0}%
...
Termination Property:
 - All the Resource managers which are not failed are either in the committed
 state or the
\end{cpar}%
\begin{cpar}{0}{T}{F}{5.0}{0}{}%
aborted state
\end{cpar}%
\begin{cpar}{1}{F}{F}{0}{0}{}%
 - The transaction manager state is also set accordingly to commit or abort
 state accordingly
\end{cpar}%
\begin{cpar}{0}{T}{T}{0}{2.5}{%
-}%
 In case the transaction manager is \mbox{'}hidden\mbox{'} then backup
 transaction manager state should be
 set to commit or abort accordingly.
\end{cpar}%
\vshade{5.0}%
\begin{cpar}{2}{F}{F}{0}{0}{}%
Consistency Property
 - No two Resource managers can be in conflicting states like - aborted and
 committed.
\end{cpar}%
\vshade{10.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 1.1 \ensuremath{RMMAYFAIL \.{=} {\FALSE}} and \ensuremath{TMMAYFAIL \.{=}
 {\FALSE}
}%
\end{cpar}%
\vshade{5.0}%
\begin{cpar}{0}{T}{F}{10.0}{0}{}%
 No errors were observed as no failures occurred and the 2 phase commit
 protocol was
 neatly executed satisfying CONSISTENCY and \ensuremath{Termination}
 properties.
\end{cpar}%
\vshade{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{RMMAYFAIL \.{=} {\TRUE}} and \ensuremath{TMMAYFAIL \.{=} {\FALSE}
}%
\end{cpar}%
\vshade{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 No errors were observed as though some resource manager failures occurred,
 the 2 phase
 commit protocol was neatly executed satisfying CONSISTENCY and
 \ensuremath{Termination} properties.
\end{cpar}%
\vshade{10.0}%
\begin{cpar}{1}{T}{T}{0}{2.5}{%
1.2}%
 \ensuremath{RMMAYFAIL \.{=} {\FALSE}} and \ensuremath{TMMAYFAIL \.{=}
 {\TRUE}}, no backup \ensuremath{TM
} Model: 4 \ensuremath{RM} nodes, 1 \ensuremath{TM
}%
\end{cpar}%
\vshade{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
Observations:
 1. Model fails with temporal property or termination property violation in
 this case.
\end{cpar}%
\vshade{5.0}%
\begin{cpar}{0}{T}{F}{7.5}{0}{}%
 \ensuremath{\.{\land} pc \.{=}} (\ensuremath{0 \.{\colongt} \@w{Done}
 \.{\,@@\,} 1 \.{\colongt} \@w{RS} \.{\,@@\,} 2 \.{\colongt} \@w{Done}
 \.{\,@@\,} 3 \.{\colongt} \@w{Done} \.{\,@@\,} 4 \.{\colongt} \@w{Done}})
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\land} rmState \.{=} {\langle}\@w{prepared},\, \@w{aborted},\,
 \@w{aborted},\, \@w{aborted}{\rangle}
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{\.{\land} tmState \.{=} \@w{hidden}
}%
\end{cpar}%
\vshade{5.0}%
\begin{cpar}{1}{T}{T}{0}{2.5}{%
2.}%
 The model failed because once the \ensuremath{TM} failed during the run,
 Resource managers which
 decided to go to \mbox{'}prepared\mbox{'} state could no longer terminate as
 they were unable
 to access \ensuremath{TM} state and hence could not move to states
 \mbox{'}committed\mbox{'} or \mbox{'}aborted\mbox{'}.
\end{cpar}%
\vshade{10.0}%
\begin{cpar}{2}{T}{T}{0}{2.5}{%
1.3}%
 When both \ensuremath{RMMAYFAIL\.{=}{\TRUE}} and
 \ensuremath{TMMAYFAIL\.{=}{\TRUE}}, and \ensuremath{ENABLEBTM\.{=}{\TRUE}}
 (the Backup \ensuremath{TM} is enabled)
 Model: 4 \ensuremath{RM} nodes, 1 \ensuremath{TM}, 1 \ensuremath{BTM}
 (backup \ensuremath{TM})
\end{cpar}%
\vshade{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
Observations:
 1. Model passes without any failures. The program satisfies both TERMINATION
 and CONSISTENCY.
\end{cpar}%
\begin{cpar}{0}{T}{F}{7.5}{0}{}%
 This is because on failure of the \ensuremath{TM}, the \ensuremath{BTM}
 becomes active and it is assumed that the \ensuremath{BTM} does not fail.
 The resource managers are now being serviced by the \ensuremath{BTM} similar
 to the \ensuremath{TM}.
\end{cpar}%
\end{lcom}%
\end{document}
